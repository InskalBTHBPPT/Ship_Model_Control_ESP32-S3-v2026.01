...
```batch
@echo off
cd /d "D:\path\to\Cpp_ReadWriteSerial-1.2-ENU-beta"
...
```batch
@echo off
cd /d "D:\Pengujian\Ship_Model_Control_ESP32-S3 v2026.01\Cpp_Files\Cpp_ReadWriteSerial-1.2-ENU-beta"
...
4. **Start in**: folder `Cpp_ReadWriteSerial-1.2-ENU-beta` (penting).

Atau PowerShell (Administrator), sesuaikan `$dir`:

```powershell
$dir = "D:\Pengujian\Ship_Model_Control_ESP32-S3 v2026.01\Cpp_Files\Cpp_ReadWriteSerial-1.2-ENU-beta"
