# Cpp_ReadWriteSerial-1.1-ENU-beta

Versi **1.1-ENU-beta** dari mini-PC serial bridge — clone dari `Cpp_Files/Cpp_ReadWriteSerial-1.0` dengan transformasi **lat/lon → ENU (internal)**.
...
### Frame lokal ENU (hanya internal)
...
| Setelah `[WP] Home: lat, lon` | koordinat home itu (`0, 0` di ENU) |
...
```powershell
cd "Cpp_Files\Cpp_ReadWriteSerial-1.1-ENU-beta"
