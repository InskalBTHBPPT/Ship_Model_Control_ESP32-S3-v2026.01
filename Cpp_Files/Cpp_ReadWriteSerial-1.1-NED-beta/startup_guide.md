...
```batch
@echo off
cd /d "D:\path\to\Cpp_ReadWriteSerial-1.1-NED-beta"
...
```batch
@echo off
cd /d "D:\Pengujian\Ship_Model_Control_ESP32-S3 v2026.01\Cpp_Files\Cpp_ReadWriteSerial-1.1-NED-beta"
...
4. **Start in**: folder `Cpp_ReadWriteSerial-1.1-NED-beta` (penting).

Atau PowerShell (Administrator), sesuaikan `$dir`:

```powershell
$dir = "D:\Pengujian\Ship_Model_Control_ESP32-S3 v2026.01\Cpp_Files\Cpp_ReadWriteSerial-1.1-NED-beta"
