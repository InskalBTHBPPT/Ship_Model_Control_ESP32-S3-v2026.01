/*
  ESP32-S3 No 1 User-Side (gateway USB <-> ESP-NOW)

  Peran:
  - Menerima telemetry 15-kolom dari Remote-Side via ESP-NOW dan
...
// =====================================================================
// Telemetry struct (diterima dari Remote-Side). 15 field, urutan & tipe
// HARUS sama dengan struct send_to_user_side di firmware Remote-Side.
// =====================================================================
