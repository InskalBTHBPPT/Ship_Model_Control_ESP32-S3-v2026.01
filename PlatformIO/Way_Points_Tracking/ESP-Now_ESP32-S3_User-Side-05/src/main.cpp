...
// =====================================================================
// Telemetry struct (diterima dari Remote-Side-05). 24 field, urutan & tipe
// HARUS sama dengan struct DatatoSend di firmware Remote-Side-05.
...
void setup() {
  Serial.begin(115200);
  Serial.println("ESP32-S3 User-Side-05");
