# ESP32-S3 Ship Model Control - ESP-NOW Sender

Sistem kontrol kapal model menggunakan ESP32-S3 yang mengirim data rudder angle, GNSS, Euler angle, dan RPM encoder melalui ESP-NOW.
